...
@Component({
  selector: 'app-edit-expenese-modal',
  templateUrl: './edit-expenese-modal.component.html',
  styleUrls: ['./edit-expenese-modal.component.css']
})
export class EditExpeneseModalComponent implements OnInit {
  ...
  constructor(public dialogRef : MatDialogRef<EditExpeneseModalComponent>, @Inject(MAT_DIALOG_DATA) public data: ExpenseEditOperation,
